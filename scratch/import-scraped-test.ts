...
import { createMailingList, parseUsersCsv } from "../lib/csv";
import { buildEmailSubject } from "../lib/email-template";
...
async function main() {
  ...
  console.log(`✅ Successfully parsed ${parsed.length} scraped Google Business leads:`);
